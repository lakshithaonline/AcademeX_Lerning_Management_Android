...
public class ModulePack02Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_module_pack02);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ModulePack02Activity.this, ModuleGalleryActivity.class);
    ...
    public void downloadWeek01(){
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFile(ModulePack02Activity.this, "Assignment", ".pdf", DIRECTORY_DOWNLOADS,url);
            }
            ...
            fileRef.putFile(fileUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(ModulePack02Activity.this, "File uploaded", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(ModulePack02Activity.this, "Upload failed", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
